...
import { VideoThumbnailSkeleton, VidoeThumbnail } from "./video-thumbnail";
...
export const VideoRowCard = ({ data, size = "default", onRemove }: VideoRowCardProps) => {
    ...
    const compactLikes = Intl.NumberFormat('en-US', {
       notation: 'compact',
    ...
    return (
        <div className={VideoRowCardVariants({ size })}>
            <Link href={`/videos/${data.id}`} className={thumbnailVariants({ size })}>
                <VidoeThumbnail imageUrl={data.thumbnailUrl} previewUrl={data.previewUrl} title={data.title} duration={data.duration} />
            </Link>
                        ...
                        {size === "default" && (
                            <>
                                ...
                                <Tooltip>
                                    ...
                                    <TooltipContent align="center" side="bottom" className="bg-black/70">
