...
export const VideoTopRow = ({ video }: VideoTopRowProps) => {
    ...
    const compactViews = Intl.NumberFormat("en", { notation: "compact" }).format(video.viewCount);
    const expandedViews = Intl.NumberFormat("en", { notation: "standard" }).format(video.viewCount);
