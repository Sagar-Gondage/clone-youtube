        ...
        <MuxUploaderDrop muxUploader={UPLOADER_ID} className="group/drop">
            <div slot="heading" className="flex flex-col items-center gap-6">
                ...
                <div className="flex flex-col gap-2 text-center">
                    <p className="text-sm">Drag and drop your files here or click to upload.</p>
                    <p className="text-xs text-muted-foreground">Your vidoes will be private untill you publish them</p>
                </div>
