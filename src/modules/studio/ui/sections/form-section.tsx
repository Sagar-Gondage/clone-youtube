...
const FormSectionSuspense = ({ videoId }: FormSectionProps) => {
    ...
    const [isThumbnailGenerateModalOpen, setIsThumbnailGenerateModalOpen] = useState(false);
    ...
    const revalidate = trpc.videos.revalidate.useMutation({
        ...
        onError: () => {
            toast.error("Error revalidating video:");
        }
    });
    ...
    const generateDescription = trpc.videos.generateDescription.useMutation({
        onSuccess: () => {
            toast.success("Description generation started!", { description: "This may take some time" });
        },
        onError: () => {
    ...
    const onSubmit = (data: z.infer<typeof videoUpdateSchema>) => {
        update.mutateAsync({ id: videoId, ...data });
    }
    ...
    return (
        <>
            <ThumbnailUploadModal open={isThumbnailModalOpen} onOpenChange={setIsThumbnailModalOpen} videoId={videoId} />
            <ThumbnailGenerateModal open={isThumbnailGenerateModalOpen} onOpenChange={setIsThumbnailGenerateModalOpen} videoId={videoId} />
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="w-full">
                    <div className="flex items-center justify-between mb-6">
                        ...
                        <div className="flex items-center gap-x-2">
                            ...
                            <DropdownMenu>
                                <DropdownMenuTrigger asChild disabled={remove.isPending}>
                                ...
                                <DropdownMenuContent align="end">
                                    ...
                                    <DropdownMenuItem onClick={() => remove.mutate({ id: videoId })} className="text-red-600">
                                        ...
                                        <FormLabel>
                                            <div className="flex items-center gap-x-2">
                                                ...
                                                <Button
                                                    ...
                                                    disabled={generateTitle.isPending || !video.muxTrackId || !video.muxPlaybackId}
                                                >
                                                    {
                                            ...
                                            <div className="p-0.5 border border-dashed bg-neutral-400 relative h-[84px] w-[153px] group">
                                                ...
                                                <DropdownMenu>
                                                    <DropdownMenuTrigger asChild>
                                                        <Button type="button" size="icon" className="bg-black/50 hover:bg-black/50 absolute top-1 right-1 rounded-full opacity-100 md:opacity-0 group-hover:opacity-100">
                                                    ...
                                                    <DropdownMenuContent align="start" side="right">
                                                        ...
                                                        <DropdownMenuItem onClick={() => restoreThumbnail.mutate({ id: videoId })} disabled={!video.thumbnailUrl}>
