...
export const videoRelations = relations(videos, ({ one, many }) => ({
    ...
    comments: many(comments),
    playlistVideos: many(playlistVidoes)
}));
...
export const videoViewRelations = relations(videoViews, ({ one }) => ({
    ...
    // views: many(videoViews), // commented becasue i was not able to load the drizzle studio in local but in neon.tech i was able to see it working
}));
...
export const commentRealations = relations(comments, ({ one, many }) => ({
    user: one(users, {
...
export const playlistVidoes = pgTable("playlist_videos", {
...
export const playlistVideoRelations = relations(playlistVidoes, ({ one }) => ({
    playlist: one(playlists, {
        fields: [playlistVidoes.playlistId],
        references: [playlists.id]
    }),
    video: one(videos, {
        fields: [playlistVidoes.videoId],
        references: [videos.id]
    })
}))