...
export const ourFileRouter = {
    ...
    thumbnailUploader: f({
        ...
        .middleware(async ({ input }) => {
            ...
            const [existingVideo] = await db.select({ thumbnailUrl: videos.thumbnailUrl }).from(videos).where(and(
            ...
            if (existingVideo.thumbnailUrl) {
                const utapi = new UTApi();
                await utapi.deleteFiles(existingVideo.thumbnailUrl);
                ...
                console.log("Deleted existing thumbnail success========");
            }
